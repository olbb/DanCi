...
import com.readboy.learnwordg.Board;
import com.readboy.learnwordg.Config;
import com.readboy.learnwordg.ErrorWord;
import com.readboy.learnwordg.LearnErrorWord;
import com.readboy.learnwordg.LearnWord;
import com.readboy.learnwordg.R;
import com.readboy.learnwordg.Rate;
import com.readboy.learnwordg.SelectWord;
import com.readboy.learnwordg.TestWords;
import com.readboy.learnwordg.Warn;
import com.readboy.learnwordg.WarnZhuCe;
...
//    public static String getTotal ="diligentDay";//获取勤奋日榜
    ...
    //称号成就对应表
    public static int cj[]=new int[]{0,0,0,1,0,0,1,0,1};
    ...
    public static int[] spendtime = new int[47];
...
//            Log.i("LearnWord","文件"+filename+"复制成功");
    ...
    static NameValuePair gradepair=new BasicNameValuePair("grade","3");
...
//                   Log.d("LearnWord",jb.toString());
                    ...
                    Log.d("LearnWord" + TYPE, EntityUtils.toString(httpResponse.getEntity()));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
//        return result;
    ...
    public static void httpget(final String TYPE, final int id) {
        ...
        getthread = new Thread(new Runnable() {
            ...
            public void run() {
                HttpClient httpClient = new DefaultHttpClient();
                HttpGet httpGet = new HttpGet(url + TYPE+"?grade=3");
