...
import com.readboy.learnwordx.Board;
import com.readboy.learnwordx.Config;
...
import com.readboy.learnwordx.Rate;
import com.readboy.learnwordx.SelectWord;
import com.readboy.learnwordx.TestWords;
import com.readboy.learnwordx.Warn;
import com.readboy.learnwordx.WarnZhuCe;
...
//    public static String getTotal ="diligentDay";//获取勤奋日榜
    ...
    static NameValuePair gradepair = new BasicNameValuePair("grade","1");
    ...
    public static int[] spendtime = new int[41];
...
//        return result;
    ...
    public static void httpget(final String TYPE, final int id) {
        ...
        getthread = new Thread(new Runnable() {
            ...
            public void run() {
                HttpClient httpClient = new DefaultHttpClient();
                HttpGet httpGet = new HttpGet(url + TYPE+"?grade=1");
